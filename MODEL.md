...
**What this is.** Plain-language statements of the design rules — the *narrative* layer: the concepts, not the
structural encoding. The structural detail lives in the canon (`docs/canon/`).
