...
| Forced-dead receive key               | Availability · 2            | Reserve             | Low (20)     | A `t_authorize` reserve quorum — forge a `Trm` rescind so the key reads dead                                                                                      | **Yes** — monitoring           | Senders can't reach you until you republish        | Republish at a fresh lineage                                  |
...
| Two-member identity                                   | Availability · 2            | Human Error    | High (600)      | One bad device freezes you; reincept                               | Add a third key to become recoverable                                                                                |
