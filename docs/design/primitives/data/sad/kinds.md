...
| `vdti/gossip/v1/protocols/handshake` | the mesh-session **handshake** — a **transient wire artifact**, signed over its SAID, never stored and never served by SAID; the one kind the witness's local sign endpoint answers ([`../../../substrate/infrastructure/mesh-transport.md`](../../../substrate/infrastructure/mesh-transport.md)) |
