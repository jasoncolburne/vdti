...
| `vdti/sel/v1/grants/*`          | a grant-value a SEL `Gnt` seals: `directory-ml-kem-1024`, `directory-ml-kem-768`, `document-membership`, `document-read-membership`, `groupkey-epoch-key`, `chat-membership` |
