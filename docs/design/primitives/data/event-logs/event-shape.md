...
| `Wit` | req       | req          | req         | req          | opt\*      | opt\*         | req          | req (`anchors`; `witnesses` / `folds` opt) |
...
| `Evl` | fbd   | req  | req          | opt (`roster`, `anchors`, `folds`)                                                   | fbd                          |
...
| `Dec` | fbd   | req  | req          | opt (`folds`; a federation `Dec` adds `clock` req)                                   | fbd                          |
| `Wit` | fbd   | req  | req          | opt (`witnesses`, `folds`; a federation `Wit` adds `clock` req + `roster` opt)       | fbd                          |
